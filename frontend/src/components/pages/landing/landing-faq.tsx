        ...
        <div className="mx-auto max-w-3xl space-y-8 py-12">
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-5">
              <AccordionTrigger>Can I integrate Nexus with other tools?</AccordionTrigger>
              <AccordionContent>
                Yes, Nexus integrates with popular tools like Slack, Google Calendar, Microsoft Teams, and more. Our
            ...
            <AccordionItem value="item-6">
              ...
              <AccordionContent>
                Absolutely. We take security seriously. Nexus uses industry-standard encryption for all data, both in
